...
/* ══════════════════════════════════════
   HANDLE FORM ACTIONS (add / delete car)
══════════════════════════════════════ */
...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if ($r && $r['image_path'] && file_exists($r['image_path'])) {
        unlink($r['image_path']);
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'add_car') {
    ...
    if (!$error_msg) {
        // Make sure the cars table exists
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .logo-name {
      ...
      font-size: 16px; letter-spacing: 0.12em; color: var(--white);
    }
    .logo-badge {
      font-size: 8px; letter-spacing: 0.25em; text-transform: uppercase;
      color: var(--red); background: rgba(232,52,26,0.12);
    ...
    .input-wrap svg {
      ...
      color: #444; pointer-events: none; flex-shrink: 0;
    }
    ...
    .field textarea {
      padding-left: 14px; resize: vertical;
    ...
    .upload-zone.drag-over { border-color: var(--red); background: rgba(232,52,26,0.08); }
    ...
    .upload-preview {
      ...
      border-radius: 6px; display: none; margin-top: 12px;
    }
    ...
    .empty-title {
      font-family: 'Bebas Neue', sans-serif;
      font-size: 24px; letter-spacing: 0.06em; color: #2a2a2a; margin-bottom: 8px;
    }
  ...
  <nav class="sidebar-nav">
    ...
    <a class="nav-item" href="#listings" onclick="document.getElementById('listings').scrollIntoView({behavior:'smooth'})">
      <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <path d="M1 10h22M5 6l2-4h10l2 4M1 14l4-4h14l4 4"/>
      </svg>
      <span>Listings</span>
    </a>
  ...
  <div class="page-content">
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card" style="--accent: var(--orange)">
        <div class="stat-icon" style="color:var(--orange)">
          <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9z"/></svg>
        </div>
        <div class="stat-num"><?php
          $cats = array_unique(array_column($all_cars,'category'));
          echo count($cats);
        ?></div>
    ...
    <div id="add-car">
      <div class="section-head" style="margin-bottom:16px">
        <div>
          <div class="section-sub">New Listing</div>
          <div class="section-title">ADD A CAR</div>
        </div>
      </div>
    </div>
        ...
        <form method="POST" enctype="multipart/form-data">
          ...
          <div class="form-grid">
            <div class="field">
              ...
              <div class="input-wrap">
                <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 0 1 0 2.828l-7 7a2 2 0 0 1-2.828 0l-7-7A2 2 0 0 1 3 12V7a4 4 0 0 1 4-4z"/></svg>
                <input type="text" name="car_name" placeholder="e.g. Land Cruiser 300" required/>
              </div>
            </div>
            <div class="field">
              <label>Brand</label>
          ...
          <div class="form-grid">
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                <input type="number" name="year" min="1990" max="2026" placeholder="2024" required/>
              </div>
            </div>
            <div class="field">
              <label>Price</label>
              <div class="input-wrap">
                <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 1 0 0 7h5a3.5 3.5 0 1 1 0 7H6"/></svg>
                <input type="text" name="price" placeholder="e.g. $45,000" required/>
              </div>
            </div>
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                <input type="number" name="kms" min="0" placeholder="e.g. 35000" required/>
              </div>
            </div>
          </div>

          <!-- Row 3: Transmission / Engine / Power / Drive / Seats -->
          <div class="form-grid">
            <div class="field">
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                <input type="text" name="engine" placeholder="e.g. V8 4.5L"/>
              </div>
            </div>
            <div class="field">
              <label>Power (HP)</label>
              <div class="input-wrap">
                <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9z"/></svg>
                <input type="text" name="power" placeholder="e.g. 285HP"/>
              </div>
            </div>
          </div>
          ...
          <div class="form-grid-2">
            <div class="field">
              ...
              <div class="input-wrap">
                <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="7" cy="18" r="2"/><circle cx="17" cy="18" r="2"/><path d="M7 16V6M17 16V6M7 6h10"/></svg>
                <select name="drive">
                  <option value="">Select</option>
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                <input type="number" name="seats" min="1" max="60" placeholder="5"/>
              </div>
            </div>
          </div>

          <!-- Row 4: Badge + Location -->
          <div class="form-grid-2">
            <div class="field">
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                <input type="text" name="location" placeholder="e.g. Beirut, Lebanon"/>
              </div>
            </div>
          </div>
          ...
          <div class="form-full field">
            ...
            <textarea name="description" placeholder="Write a compelling description of the vehicle — condition, history, features, seller notes..."></textarea>
          </div>
          ...
          <div class="form-actions">
            ...
            <button type="reset" class="btn-ghost" onclick="document.getElementById('imagePreview').style.display='none'">
              Clear Form
            </button>
          </div>
        </form>
    ...
    <div id="listings">
      <div class="section-head" style="margin-bottom:16px">
        <div>
          <div class="section-sub">Manage</div>
        ...
        <tbody>
          ...
          <tr>
            <td>
              ...
              <?php else: ?>
                <div class="td-img-placeholder">
                  <svg width="18" height="12" fill="none" stroke="#333" stroke-width="1.5" viewBox="0 0 24 16">
                    <rect x="1" y="1" width="22" height="14" rx="2"/><circle cx="8" cy="7" r="2"/>
            ...
            <td>
              <button class="del-btn" onclick="confirmDelete(<?php echo $car['id']; ?>, '<?php echo addslashes($car['car_name']); ?>')">
                Remove
              </button>
            </td>
          </tr>
...
">
  <div style="
    ...
    border-radius:10px;padding:40px;max-width:440px;width:90%;
    position:relative;
  ">
    <div style="
    ...
    <div style="font-family:'Bebas Neue',sans-serif;font-size:24px;letter-spacing:.06em;color:var(--white);text-align:center;margin-bottom:8px">
      Remove Listing?
    </div>
    <div style="font-size:13px;color:var(--muted);text-align:center;line-height:1.7;margin-bottom:28px" id="deleteModalMsg">
      This will permanently remove the car from DriveHub.
    </div>
    <div style="display:flex;gap:10px;justify-content:center;">
      <button onclick="document.getElementById('deleteModal').style.display='none'"
        style="padding:12px 24px;background:transparent;border:1px solid var(--border);border-radius:6px;
               color:var(--text);font-family:'DM Sans',sans-serif;font-size:13px;cursor:pointer;">
        Cancel
      </button>
      <a id="deleteConfirmLink" href="#"
        style="padding:12px 28px;background:var(--red);border:none;border-radius:6px;
               color:#fff;font-family:'Bebas Neue',sans-serif;font-size:16px;letter-spacing:.1em;
...
<script>
  ...
  function confirmDelete(id, name) {
    document.getElementById('deleteModalMsg').textContent =
      `"${name}" will be permanently removed from all listings.`;
